(function(){
	...
	angular
	.module(moduleName)
	.controller("IndividualUserController", ['$scope', '$location', '$window', 'EventService', '$routeParams', 'UserService', 
		function($scope, $location, $window, EventService, $routeParams, UserService) {
			...
			//console.log("$scope.friendId", $scope.friendId)
